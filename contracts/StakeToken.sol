...
contract MintableToken is StandardToken, Ownable {
  ...
  function mint(address _to, uint _amount, uint tokenDecimals) public returns (bool) {
    require(!mintingFinished);
    totalSupply = totalSupply.add(_amount * 10**tokenDecimals);
    balances[_to] = balances[_to].add(_amount*10**tokenDecimals); 
    return true;
  }
