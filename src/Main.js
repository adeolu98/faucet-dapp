        ...
        return (
            ...
            <div class="card card-props" style = {{backgroundColor: "#333F47"}}>
                <div class="card-body border border-secondary rounded shadow-lg">
                    ...
                    <h4 className="space-text"><p style={{ color: "white" }}> Get tokens by clicking the button below. <br></br> <br></br>You won't get more tokens if you have presently have a 1000 or more </p></h4> <br></br>
